...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_4___default.a {
  static async getInitialProps({
    ...
    const styleTags = sheet.getStyleElement(); // see https://github.com/nfl/react-helmet#server-usage for more information
    // 'head' was occupied by 'renderPage().head', we cannot use it

    return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__["default"])({}, page, {
      styleTags,
      helmet: react_helmet__WEBPACK_IMPORTED_MODULE_5___default.a.rewind()
    });
  ...
  helmetHeadComponents() {
    const keys = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(this.props.helmet).filter(el => el !== 'htmlAttributes').map(el => this.props.helmet[el].toComponent()).filter(el => el.length > 0 || !(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(el).length === 0 && el.constructor === Object));
  ...
  render() {
    return __jsx("html", Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
      lang: "en"
    }, this.helmetHtmlAttrComponents()), __jsx(next_document__WEBPACK_IMPORTED_MODULE_4__["Head"], null, __jsx("meta", {
      name: "robots",
    ...
    }), this.helmetHeadComponents(), this.props.styleTags), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_4__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_4__["NextScript"], null)));
  }
